...
| **Asistente de Tesorería** | Todos los casos | En casos en Tesorería no finalizados: cambiar estados **no finales**; editar nivel académico; **liquidar (fijar porcentaje y destino)**; **adjuntar documentos** (internos o visibles al estudiante, ej. la planilla); enviar al Centro Médico o, con liquidación completa, a Revisión y ejecución | Tocar casos en manos de otro paso o cerrados; fijar aprobado/rechazado; enviar a Revisión y ejecución sin liquidar; sacar casos de `falta_documentacion` |
...
| **Estudiante / tercero** (canal público, sin login) | Solo su caso con el enlace | Consultar con número + código (se exige en cada acceso), comentar, adjuntar documentos cuando se le piden, descargar los adjuntos visibles, ver trazabilidad con hora de Colombia | Todo lo demás |
