...
| **Asistente de Tesorería** | Todos los casos | En casos en Tesorería no finalizados: cambiar estados **no finales**; editar nivel académico; **liquidar (fijar porcentaje y destino)**; enviar al Centro Médico o, con liquidación completa, a Revisión y ejecución | Tocar casos en manos de otro paso o cerrados; fijar aprobado/rechazado; enviar a Revisión y ejecución sin liquidar; sacar casos de `falta_documentacion` |
